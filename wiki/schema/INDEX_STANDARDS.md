...
* [[Mixture of Experts]] - Neural network architecture routing tokens to specialized subnetworks.
* [[Vibe Coding]] - Rapid prototyping using LLMs and natural language commands.

## 🏢 Entity Directory
[List of all `wiki/entities/` files. Alphabetical order.]
* [[Claude 3.5]] - Foundation model developed by Anthropic.
* [[DeepSeek-V3]] - Open-weight MoE model by DeepSeek.
* [[Obsidian]] - Local-first markdown knowledge base.

## 📚 Source Directory
[List of all `wiki/sources/` files. Chronological order, oldest to newest.]
* [[20251128_inbox_AI_coding_assistants]] - Review of early AI coding tools.
* [[20260410_inbox_DeepSeek_MoE_Architecture]] - Technical breakdown of the V3 routing logic.
* [[20260414_inbox_karpathy_llm_wiki]] - The foundational architecture for this knowledge base.