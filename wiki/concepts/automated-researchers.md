...
updated: 2026-04-11
source_count: 1
summary_en: Automated researchers are AI systems that sustain meaningful research work over longer horizons with less explicit human instruction.
summary_zh: 自动化研究员是能在更长时间跨度内持续推进研究工作的 AI 系统，而且需要更少的显式人工指令。
source_files:
...
- The key variable is autonomy, not just intelligence in short benchmarks:
  ...
  spans.
- Coding and mathematics serve as staging grounds because progress can be
  tested more cleanly there than in many ambiguous real-world domains.
- Human comparative advantage shifts toward choosing directions, evaluating
  importance, and setting the research agenda.
- The concept raises governance questions because a small number of people may
  be able to direct much larger quantities of cognitive labor.
...
- 编程和数学是重要的中间试验场，因为相比许多模糊的现实领域，这里更容易清晰地测试
  进展。
- 人类的比较优势会转向选择方向、评估重要性和设定研究议程。
- 这个概念会带来治理问题，因为少数人可能就能调动大规模认知劳动。
- 出于安全与可解释性考虑，可能需要观察内部推理，但又不能把这种推理直接变成面向用
  户的产物。
...
- [[From Coding Automation to Research Automation]]: frames research autonomy as
  a continuation of the agentic engineering trend.
...
- [[From Coding Automation to Research Automation]]：把研究自治看作智能体工程趋势
  的延续。
- [[Programming Eats Knowledge Work]]：解释为什么编码自动化可能扩展成更广泛的认
  知工作流。
